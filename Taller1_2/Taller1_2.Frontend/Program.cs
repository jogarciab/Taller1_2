...
var parallelogram = new Parallelogram(nameof(Parallelogram), 14.65, 54.7, 23.09);
var triangle = new Triangle(nameof(Triangle), 45.56, 12.34, 27.09, 15);
var trapeze = new Trapeze(nameof(Trapeze), 10, 20, 30, 40, 20);

var figures = new List<GeometricFigure>() { circle, square, rhombous, kite, rectangle, parallelogram, triangle, trapeze };
